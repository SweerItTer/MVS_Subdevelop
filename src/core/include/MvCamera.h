...
public:
	...
	static int EnumDevices(unsigned int nTLayerType = MV_GIGE_DEVICE|MV_USB_DEVICE,
						   MV_CC_DEVICE_INFO_LIST* pstDevList = nullptr,
						   const char *strManufacturerName = NULL,
						   MV_SORT_METHOD enSortMethod = SortMethod_SerialNumber);
    ...
    // MV_CC_DEVICE_INFO* GetDeviceInfoEx(int index);
